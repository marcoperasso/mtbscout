...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPanel" runat="Server">
    <div id="ContentPanel" class="ContentPanel">
        ...
        &nbsp;<h3>
            Il percorso</h3>
            <p>20 Km suddivisi in tre salite su asfalto e altrettante discese sterrate. I meno 
                preparati possono decidere di affrontare anche solo una o due delle tre prove. La terza in particolare è piuttosto dura, 
                tenetelo presente, anche se a nostro avviso merita proprio di essere affrontata, 
                quindi... allenatevi e mettetevi in gioco!!!</p>
        <p>
        ...
        <p>
            ...
            che si imboccherà per la terza risalita.</p>
        <p>
            PS3: la lunghissima spaccabraccia. Da località Fasciou si arriva alla cappelletta
