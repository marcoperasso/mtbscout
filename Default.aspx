...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPanel" runat="Server">
    <div id="ContentPanel" class="ContentPanel">
        <div id="NewsBanner" class="NewsBanner">
            ...
            <a href="Events/TouristTrophyTorriglia2015/TouristTrophyTorriglia2015.aspx">
                <img id="BannerImage" border="0" alt="" src="Events/TouristTrophyTorriglia2015/locandina.jpg" style="width:90%;height:90%" />
            </a>
        </div> <%----%>
